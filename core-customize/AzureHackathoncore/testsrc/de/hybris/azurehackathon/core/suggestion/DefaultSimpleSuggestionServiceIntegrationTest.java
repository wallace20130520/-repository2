 ...
 */
package de.hybris.azurehackathon.core.suggestion;
...
import de.hybris.azurehackathon.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/AzureHackathoncore/test/testSimpleSuggestionService.csv", "utf-8");
	}
