 ...
 */
package com.hybris.backoffice.workaround.ecp5193.jalo;
...
import com.hybris.backoffice.workaround.ecp5193.constants.Ecp5193workaroundConstants;
 ...
 */
public class Ecp5193workaroundManager extends GeneratedEcp5193workaroundManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Ecp5193workaroundManager.class.getName());
	 ...
	 */
	public static Ecp5193workaroundManager getInstance()
	{
		return (Ecp5193workaroundManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Ecp5193workaroundConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Ecp5193workaroundManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Ecp5193workaroundManager called.");
		}
	}
