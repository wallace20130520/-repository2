...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/AzureHackathonstorefront/electronics/en",
						"https://electronics.local:9002/AzureHackathonstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/AzureHackathonstorefront/electronics/en",
						"https://electronics.local:9002/AzureHackathonstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/AzureHackathonstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/AzureHackathonstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/AzureHackathonstorefront/electronics/en",
						"https://electronics.local:9002/AzureHackathonstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/AzureHackathonstorefront",
						"https://electronics.local:9002/AzureHackathonstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/AzureHackathonstorefront",
						"https://electronics.local:9002/AzureHackathonstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/AzureHackathonstorefront/electronics/en",
						"https://electronics.local:9002/AzureHackathonstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
