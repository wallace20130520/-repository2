 ...
 */
package de.hybris.azurehackathon.fulfilmentprocess.test.jobs;
...
import de.hybris.azurehackathon.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = AzureHackathonFulfilmentProcessConstants.ORDER_PROCESS_NAME;
