...
import de.hybris.azurehackathon.fulfilmentprocess.test.actions.TestActionTemp;
...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception
	{
		...
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/AzureHackathonfulfilmentprocess/test/AzureHackathonfulfilmentprocess-spring-test.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/AzureHackathonfulfilmentprocess/test/AzureHackathonfulfilmentprocess-spring-test-fraudcheck.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/AzureHackathonfulfilmentprocess/test/process/order-process-spring.xml"));
		...
		definitonFactory.add("classpath:/AzureHackathonfulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/AzureHackathonfulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/AzureHackathonfulfilmentprocess/test/testCatalog.csv", "windows-1252");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/AzureHackathonfulfilmentprocess/test/AzureHackathonfulfilmentprocess-spring-testcleanup.xml"));
