 ...
 */
package de.hybris.azurehackathon.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(AzureHackathonFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AzureHackathonFulfilmentProcessConstants.PARENT_PROCESS);
