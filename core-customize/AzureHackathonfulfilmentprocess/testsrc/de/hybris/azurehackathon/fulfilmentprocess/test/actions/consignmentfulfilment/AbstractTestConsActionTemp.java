 ...
 */
package de.hybris.azurehackathon.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, AzureHackathonFulfilmentProcessConstants.PARENT_PROCESS);
