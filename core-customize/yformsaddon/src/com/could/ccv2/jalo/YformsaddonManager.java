...
/**
 * This is the extension manager of the Yformsaddon extension.
 */
public class YformsaddonManager extends GeneratedYformsaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(YformsaddonManager.class.getName());
	 ...
	 */
	public static YformsaddonManager getInstance()
	{
		return (YformsaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				YformsaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public YformsaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of YformsaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of YformsaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of YformsaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
