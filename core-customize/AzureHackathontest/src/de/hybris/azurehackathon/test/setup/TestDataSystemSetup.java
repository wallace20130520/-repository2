 ...
 */
package de.hybris.azurehackathon.test.setup;
...
import de.hybris.azurehackathon.test.constants.AzureHackathonTestConstants;
import de.hybris.azurehackathon.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AzureHackathonTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/AzureHackathontest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/AzureHackathontest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/AzureHackathontest/import/cstickets.impex");
			...
			importImpexFile(context, "/AzureHackathontest/import/csquotes.impex");
		}
	}
}
