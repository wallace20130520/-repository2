...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/ccv2storefront/electronics/en",
						"https://electronics.local:9002/ccv2storefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/ccv2storefront/electronics/en",
						"https://electronics.local:9002/ccv2storefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/ccv2storefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/ccv2storefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/ccv2storefront/electronics/en",
						"https://electronics.local:9002/ccv2storefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/ccv2storefront",
						"https://electronics.local:9002/ccv2storefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/ccv2storefront",
						"https://electronics.local:9002/ccv2storefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/ccv2storefront/electronics/en",
						"https://electronics.local:9002/ccv2storefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
